...
*/
#define X_PROBE_OFFSET -39     // For KP5L Stealthburner harness BLTouch left side
#define Y_PROBE_OFFSET -2     // For KP5L Stealthburner harness BLTouch slightly in front of nozzle
#define Z_PROBE_OFFSET -0.90  // VVL: After manual z offset
...
#define STRING_CONFIG_H_AUTHOR "VicVL" // Who made the changes.  // GR
...
#define CUSTOM_MACHINE_NAME "KP5L-SB"
...
#define HEATER_0_MAXTEMP 300 // Max Rated temp for e3d v6 Ceramic Clone
 ...
 */
#define HOTEND_OVERSHOOT 15   // (°C) Forbid temperatures over MAXTEMP - OVERSHOOT // GR proviamo a raggiungere 290 gradi
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.55, 165.26, 789.7, 1406.08 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 310   // VVL Added  a cm of out of bed travel on the X rail 
...
//#define DEBUG_LEVELING_FEATURE
...
#if ANY(AUTO_BED_LEVELING_LINEAR, AUTO_BED_LEVELING_BILINEAR, AUTOAUTO_BED_LEVELING_UBL)
  ...
  //#define AVOID_OBSTACLES
    ...
    #define CLIP_H  25  // Bed clip height, should be padded a few mm over its physical size
...
// #define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN                  PB2 // LED driving pin, last white socket at the bottom left of the board, next to the 3dTouch pins. Pinout is: Signal - Ground - 5v
